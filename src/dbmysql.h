...
#ifndef DISH_DB_MYSQL_H
#define DISH_DB_MYSQL_H
...
namespace dish
{
    ...
    class MySqlDatabaseConnection : public DbConnection
    {
        private:
            MYSQL mConnection;
        ...
        protected:
            ...
            static std::string formatError(const std::string &msgtext, const int errcode, const std::string &errmsg);
            
            void checkError(const int error);
    
        public:
            MySqlDatabaseConnection(const iDbConnection::ConnectionParams &conparams);
